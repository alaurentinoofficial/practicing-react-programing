...
> Importante: Todos os `valInput` possuem id de acordo com sua posição na tabela. Isto serve por exemplo para facilitar a construção de dependências (criar referências) entre células.
